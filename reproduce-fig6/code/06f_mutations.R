...
called_variants <- colnames(fread("../data/PBMC_NBT_channel01_hg38_v20-mtMask.cell_heteroplasmic_df.tsv.gz"))[-1]
...
cowplot::ggsave2(p1, file = "../plots/allmutaitons_mito_signature.pdf", width = 4, height = 2)